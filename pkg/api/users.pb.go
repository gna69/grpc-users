...
func (x *AllUsers) GetUsers() []*UserInfo {
	if x != nil {
		return x.Users
	}
	return nil
...
var file_users_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x22, 0x54, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e,
	...
	0x6c, 0x61, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x2f, 0x0a, 0x08, 0x41, 0x6c, 0x6c, 0x55,
	...
	,
}
...
var file_users_proto_goTypes = []interface{}{
	...
	(*AllUsers)(nil), // 1: api.AllUsers
	(*Empty)(nil),    // 2: api.Empty
}
var file_users_proto_depIdxs = []int32{
	0, // 0: api.AllUsers.users:type_name -> api.UserInfo
	0, // 1: api.User.Add:input_type -> api.UserInfo
	0, // 2: api.User.Remove:input_type -> api.UserInfo
	2, // 3: api.User.GetAll:input_type -> api.Empty
	0, // 4: api.User.Add:output_type -> api.UserInfo
	0, // 5: api.User.Remove:output_type -> api.UserInfo
	1, // 6: api.User.GetAll:output_type -> api.AllUsers
